...
public class SecondaryServerB {
	...
	public static void serverHistory(String user, String command, String filename) throws IOException {
		BufferedWriter br = new BufferedWriter(new FileWriter("serverHistoryB.txt", true));
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Server2B is running on " + port);
			...
			try {
				...
				while ((input = br.readLine()) != null) {
					...
					if (command[0].equals("add")) {
						...
						File file = new File("ServerBlist/" + command[1]);
						try {
						...
						System.out.println("Error on server 2B");
					}

				}

				socket.close();
				System.out.println("The connection 2B was closed: " + socket);
