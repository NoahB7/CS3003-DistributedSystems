...
public class SecondaryServerB_v3 {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Server3 is running on " + port);
			...
			try {
				...
				while ((input = br.readLine()) != null) {
					...
					if (command[0].equals("add")) {
						...
						out.println("File added on server 2B: " + command[1]);
						...
						out.println("File removed on server 2B: " + command[1]);
					} else if (command[0].equalsIgnoreCase("listAll")) {
						
						out.println("Server 2B list all: " + fileList);
